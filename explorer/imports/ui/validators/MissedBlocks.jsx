    ...
    render() {
        if (this.props.loading){
            ...
            if (this.props.validatorExist){
                return <div>
                    <Helmet>
                        <title>{ this.props.validator.description.moniker } - Missed Blocks | Persistence-Blockchian</title>
                        <meta name="description" content={"The missed blocks and precommits of "+this.props.validator.description.moniker} />
                    </Helmet>
                    <Link to={"/validator/"+this.props.validator.address} className="btn btn-link"><i classame="fas fa-caret-left"></i> <T>validators.backToValidator</T></Link>
