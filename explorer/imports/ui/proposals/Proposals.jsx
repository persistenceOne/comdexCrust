...
export default class Proposals extends Component{
    ...
    render() {
        return <div>
            <Helmet>
                <title>Governance Proposals on Commit-Hub</title>
                <meta name="description" content="Commit Hub incorporates on-chain governance. Come to see how on-chain governance can be achieved on The  Commit-Hub Explorer" />
            </Helmet>
            <Row>
