                    ...
                    this.setState({
                        ...
                        delegations: delegations.map((d, i) => {
                            return <Row key={i} className="delegation-info">
                                <Col xs={6} md={8} className="text-nowrap overflow-auto"><AccountTooltip address={d.validator_addr} /></Col>
                                <Col xs={6} md={4}>{numbro(d.shares/Meteor.settings.public.stakingFraction).format("0,0")}</Col>
                            </Row>
                        })
                    })
                }
