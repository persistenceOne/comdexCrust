...
export default class AccountDetails extends Component{
            ...
            if (result){
                if (result.available){
                    this.setState({
                        ...
                        total: parseFloat(this.state.total)+parseFloat(result.available*Meteor.settings.public.stakingFraction)
                    })
                }
    ...
    render(){
        if (this.state.loading){
            ...
            return <div id="account">
                <Helmet>
                    <title>Account Details of {this.state.address} on Commit Hub</title>
                    ...
                    <Col><Card>
                        ...
                        <CardBody>
                            <Row className="account-distributions">
                                <Col xs={12}>
                                    <Progress multi>
                                        <Progress bar className="available" value={this.state.available} />
                                        {/* {this.state.available/this.state.total*100} */}
                                        ...
                                        {/* {this.state.commission/this.state.total*100} /> */}
                                    </Progress>
                                </Col>
                            </Row>
                            <Row>
                                <Col md={6} lg={8}>
                                    <Row>
                                        ...
                                        <Col xs={8} className="value text-right">{numbro(this.state.available).format("0,0.0000")}</Col>
                                    </Row>
                                    <Row>
