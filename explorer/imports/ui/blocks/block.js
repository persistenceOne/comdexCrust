    ...
    render() {
        ...
        if (proposer){
            ...
            return <Row className="block-info">
                ...
                <Col xs={4} sm={2} className="text-truncate"><i className="fas fa-hashtag d-sm-none"></i> { this.props.block.lastBlockHash}</Col>
            ...
            return <div className="blockrow">No data</div>
        }
    }
}