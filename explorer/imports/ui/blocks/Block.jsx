    ...
    render(){
        if (this.props.loading){
            ...
            if (this.props.blockExist){
                ...
                return <Container id="block">
                    <Helmet>
                        <title>Block {numbro(block.height).format("0,0")} on Commit Hub Explorer</title>
                    ...
                    <Card>
                        ...
                        <CardBody>
                            <Row>
                                ...
                                <Col md={8} className="value"><Link to={"/validator/"+((proposer)?block.proposerAddress:'')}><Avatar moniker={moniker} identity={identity} address={block.proposerAddress} list={true} /> {moniker}</Link></Col>
