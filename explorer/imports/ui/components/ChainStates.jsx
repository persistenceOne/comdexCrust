        ...
        return <Card className="d-lg-inline-block">
            {/* <CardHeader>
                <Row className="text-nowrap">
                    <Col xs={4} md="auto"><small><span><T>chainStates.price</T>:</span> <strong>{}</strong></small></Col>
                    <Col xs={8} md="auto"><small><span><T>chainStates.marketCap</T>:</span> <strong>{}</strong></small></Col>
                    <Col xs={4} md="auto"><small><span><T>chainStates.inflation</T>:</span> <strong>{}</strong></small></Col>
                    <Col xs={8} md="auto"><small><span><T>chainStates.communityPool</T>:</span> <strong>{}</strong></small></Col>
                </Row>
            </CardHeader> */}
        </Card>
    }
