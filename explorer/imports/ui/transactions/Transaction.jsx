    ...
    render(){
        if (this.props.loading){
            return <Container id="transaction">
                <Spinner type="grow" color="primary" /> NewOne
            </Container>
        }
        else{
            if (this.props.transactionExist){
                ...
                return <Container id="transaction">
                    <Helmet>
                        <title>Transaction {tx.hash} on Commit-Hub </title>
                    ...
                    <Card>
                        ...
                        <CardBody>
                            <Row>
                                ...
                                <Col md={8} className="value">{numbro(tx.result.gas_used).format("0,0")} / {numbro(tx.result.gas_wanted).format("0,0")}</Col>
