...
func runAddCmd(cmd *cobra.Command, args []string) error {
	...
	if viper.GetString(FlagPublicKey) != "" {
		pk, err := cTypes.GetAccPubKeyBech32(viper.GetString(FlagPublicKey))
		if err != nil {
			return err
		}
	...
	if viper.GetBool(flags.FlagUseLedger) {
		bech32PrefixAccAddr := cTypes.GetConfig().GetBech32AccountAddrPrefix()
...
func AddNewKeyRequstHandler(w http.ResponseWriter, r *http.Request) {
