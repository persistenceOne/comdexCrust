...
func (ar AccountRetriever) GetAccount(addr cTypes.AccAddress) (exported.Account, error) {
...
// or decoding fails.
func (ar AccountRetriever) GetAccountWithHeight(addr cTypes.AccAddress) (exported.Account, int64, error) {
...
func (ar AccountRetriever) EnsureExists(addr cTypes.AccAddress) error {
...
func (ar AccountRetriever) GetAccountNumberSequence(addr cTypes.AccAddress) (uint64, uint64, error) {
