...
const (
	...
	DefaultPeriod = time.Second * 60 * 5 // 5 minutes  time.Second*60*5
)
...
func DefaultGenesisState() GenesisState {
	...
	return GenesisState{
		...
		DepositParams: DepositParams{
			MinDeposit:       sdk.Coins{sdk.NewCoin(types.BondDenom, minDepositTokens)},
...
func (data GenesisState) Equal(data2 GenesisState) bool {
	b1 := govTypes.ModuleCdc.MustMarshalBinaryBare(data)
	b2 := govTypes.ModuleCdc.MustMarshalBinaryBare(data2)
