...
// NewDecFromBigInt : create a new Dec from big integer assuming whole numbers
// CONTRACT: prec <= Precision
func NewDecFromBigInt(i *big.Int) Dec {
	return NewDecFromBigIntWithPrec(i, 0)
}

// NewDecFromBigIntWithPrec : create a new Dec from big integer assuming whole numbers
// CONTRACT: prec <= Precision
