...
func NewNegotiation(buyerAddress, sellerAddress cTypes.AccAddress, pegHash PegHash) Negotiation {
	return &BaseNegotiation{
...
func GenerateNegotiationIDBytes(buyerAddress cTypes.AccAddress, sellerAddress cTypes.AccAddress, pegHash PegHash) []byte {
