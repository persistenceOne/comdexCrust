...
// Committer something that can persist to disk
...
//CommitStore Stores of MultiStore must implement CommitStore.
...
// CacheMultiStore From MultiStore.CacheMultiStore()....
type CacheMultiStore interface {
	MultiStore
	Write() // Writes operations to underlying KVStore
}

// CommitMultiStore : A non-cache MultiStore.
...
// Iterator : Alias iterator to db's Iterator for convenience.
type Iterator = dbm.Iterator

// KVStorePrefixIterator : Iterator over all the keys with a certain prefix in ascending order
func KVStorePrefixIterator(kvs KVStore, prefix []byte) Iterator {
	return kvs.Iterator(prefix, PrefixEndBytes(prefix))
}

// KVStoreReversePrefixIterator : Iterator over all the keys with a certain prefix in descending order.
...
//CommitKVStore : Stores of MultiStore must implement CommitStore.
...
// KVPair : key-value result for iterator queries
