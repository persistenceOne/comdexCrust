...
func QueryNegotiationRequestHandlerFn(storeName string, cdc *wire.Codec, decoder sdk.NegotiationDecoder, cliContext context.CLIContext) http.HandlerFunc {
