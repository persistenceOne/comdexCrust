...
// ExecuteFiatCmd : Send an fiat to order with a buyer
func ExecuteFiatCmd(cdc *wire.Codec) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "executeFiat",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := fiatFactory.BuildExecuteFiatMsg(from, ownerAddress, to, assetPegHash, sdk.FiatPegWallet{fiatPeg})
