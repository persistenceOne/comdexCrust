...
//SendAssetHandlerFunction : handles send asset rest message
func SendAssetHandlerFunction(cliCtx context.CLIContext, cdc *wire.Codec, kb keys.Keybase, kafka bool, kafkaState rest.KafkaState) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		var msg assetFactory.SendAssetBody
		...
		buildmsg := assetFactory.BuildSendAssetMsg(from, owner, to, pegHash)

		if kafka == true {
			ticketID := rest.TicketIDGenerator("AFSA")
