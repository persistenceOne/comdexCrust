...
func RedeemAssetHandlerFunction(cliCtx context.CLIContext, cdc *wire.Codec, kb keys.Keybase, kafka bool, kafkaState rest.KafkaState) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		var msg assetFactory.RedeemAssetBody
		...
		buildmsg := assetFactory.BuildRedeemAssetMsg(from, owner, to, pegHash)

		if kafka == true {
			ticketID := rest.TicketIDGenerator("AFRA")
