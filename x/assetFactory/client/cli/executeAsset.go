...
// ExecuteAssetCmd : Send an asset to order with a buyer
func ExecuteAssetCmd(cdc *wire.Codec) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "executeAsset",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := assetFactory.BuildExecuteAssetMsg(from, ownerAddress, to, pegHash)
