...
import (
	...
	types "github.com/commitHub/commitBlockchain/x/stake/types"
...
func (k Keeper) Slash(ctx sdk.Context, pubkey crypto.PubKey, infractionHeight int64, power int64, slashFactor sdk.Dec) {
	...
	// ref https://github.com/commitHub/commitBlockchain/issues/1348
	// ref https://github.com/commitHub/commitBlockchain/issues/1471
...
func (k Keeper) slashUnbondingDelegation(ctx sdk.Context, unbondingDelegation types.UnbondingDelegation,
	...
	if !unbondingSlashAmount.IsZero() {
		...
		// Burn loose tokens
		// Ref https://github.com/commitHub/commitBlockchain/pull/1278#discussion_r198657760
